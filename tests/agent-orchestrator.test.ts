...
async function runAgentOrchestratorTests() {
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("AGENT ORCHESTRATION & REASONING TEST SUITE");
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
  ...
  assert(
    dangerReview.verdict === "REJECTED",
    "Critic flags dangerous fix plan as REJECTED",
  );

  // 3. Task Planner
  const planner = new TaskPlanner();
  const planResult = await planner.classify(
    "Fix merge conflict in src/agent/planner.ts and add test suite",
  );
  ...
  const classification = await planner.classify(
    "Git merge conflict between development and feature branch",
  );
  assert(
    classification.taskClass === "MERGE_CONFLICT",
    "TaskPlanner classified conflict resolution task accurately",
  );
  ...
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log(`AGENT ORCHESTRATION TEST RESULTS: ${passed} Passed, ${failed} Failed.`);
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
