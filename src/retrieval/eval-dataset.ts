...
export const retrievalEvalDataset: readonly RetrievalEvalCase[] = [
  ...
  { id: "entity-search", query: "How do we find graph entities by name?", expectedNames: ["findEntitiesByName"] },
  {
    ...
    expectedNames: ["extractEntities", "extractEntitiesFromFile"],
  },
  {
    id: "relationship-extraction",
    query: "How are relationships extracted from source code?",
    expectedNames: ["extractRelationships", "extractRelationshipsFromFile"],
  },
  ...
  { id: "reranking", query: "How are retrieval results reranked?", expectedNames: ["rerankResults"] },
  {
    ...
    expectedNames: ["parseRepository", "scanRepository"],
  },
  {
    id: "graph-neighbors-nl",
    query: "Which function walks both incoming and outgoing edges?",
    expectedNames: ["getNeighbors", "traverseGraph"],
  },
  {
    id: "hybrid-fusion-nl",
