...
export class RepositoryIndexer {
  ...
  public watchRepository(
    onChange?: (stats: IncrementalIndexStats) => void,
    debounceMs = 300,
  ): void {
    if (this.watcher) {
      return;
